      ...
      while ($row=$sql->fetch(PDO::FETCH_ASSOC)) {  ?>
        ...
        <tr> 
         ...
         <td><?php echo $row['products_price'] ?></td>
          ...
          <td align="center" width="5"><a href="sales.php?salesDelete=True&sales_id=<?php echo $row['sales_id'] ?>&file_delete=<?php echo $row['sales_file'] ;?>"><i class="fa fa-trash-o"></i></a></td>
        </tr>
